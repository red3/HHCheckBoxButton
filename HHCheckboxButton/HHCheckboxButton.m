...
@interface HHCheckboxButton ()
{
    UIView *_wrapperView;
    
    CALayer *_checkBackground;
    
    HHCheckboxButtonStyle _style;
    CGSize _size;
    bool _borderOnTop;
    UIImage *_fillImage;
...
@implementation HHCheckboxButton

static CGAffineTransform HHCheckboxButtonDefaultTransform;
...
- (instancetype)initWithStyle:(HHCheckboxButtonStyle)style
{
    ...
    if (style == HHCheckboxButtonStyleGallery)
    ...
    if (self != nil)
    {
        ...
        dispatch_once(&onceToken, ^
                      {
                          HHCheckboxButtonDefaultTransform = CGAffineTransformMakeRotation(-M_PI_4);
        ...
        switch (style)
        {
            case HHCheckboxButtonStyleGallery:
            {
                insideInset = 3.5f;
                borderOnTop = true;
            }
                
            case HHCheckboxButtonStyleMedia:
            {
                insideInset = 4.0f;
                borderOnTop = true;
            }
...
- (void)_createCheckButtonDetailsIfNeeded
{
    ...
    _checkView.transform = HHCheckboxButtonDefaultTransform;
    ...
    if (_style == HHCheckboxButtonStyleGallery)
    {
